...
import td3.visitors.*;
import td3.visitorsImpl.PrintRapportCommandes;
import td3.visitorsImpl.XMLRapportCommandes;
...
public final class Main{
    ...
    public static void main(String[] args) throws MonException, Exception {
